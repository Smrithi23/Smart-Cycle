...
<body>
    <?php
        $message = "";
        $error = "";
        include_once $_SERVER['DOCUMENT_ROOT']."/Smart-Cycle/Project/modules/user/register.php";
    ?>
...
<form class="form-horizontal" id="register-form" action="" method="POST">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" name="register-submit" value="Register" class="btn btn-default">Register</button>
      </div>
    </div>
  </form>
  <?php echo $message; ?>
