...
cursor.execute("DROP TRIGGER IF EXISTS Hash_Password")
print("Dropped Hash_Password Trigger")

print("--------------------------------------------------")
print("Creation :")
print("--------------------------------------------------")
cursor.execute("CREATE TABLE Station (station_id INT AUTO_INCREMENT PRIMARY KEY, station_name VARCHAR(255) NOT NULL)")
print("Created Station Table")
cursor.execute("CREATE TABLE Stand (stand_id INT AUTO_INCREMENT PRIMARY KEY, stand_name VARCHAR(255) NOT NULL, station_id INT NOT NULL, FOREIGN KEY(station_id) REFERENCES Station(station_id))")
print("Created Stand Table")
cursor.execute("CREATE TABLE Cycle (cycle_id INT AUTO_INCREMENT PRIMARY KEY, cycle_number INT NOT NULL, availability BOOL NOT NULL, stand_id INT NOT NULL, FOREIGN KEY(stand_id) REFERENCES Stand(stand_id))")
print("Created Cycle Table")
cursor.execute("CREATE TABLE User (user_id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone_number VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL)")
print("Created User Table")
cursor.execute("CREATE TABLE Cycle_Usage (cycle_id INT NOT NULL, user_id INT NOT NULL, start_date DATE NOT NULL, start_time TIME NOT NULL, card_no INT NOT NULL, exp_month INT NOT NULL, exp_year YEAR NOT NULL, cvv INT NOT NULL, FOREIGN KEY(cycle_id) REFERENCES Cycle(cycle_id))")
print("Created Cycle_Usage Table")
cursor.execute("CREATE TABLE Admin (admin_id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL)")
print("Created Admin")
cursor.execute("CREATE TRIGGER Hash_Password BEFORE INSERT ON User FOR EACH ROW BEGIN SET NEW.password = MD5(NEW.password); END")
print("Created Hash_Password")
...
sql = "INSERT INTO Stand (stand_id, stand_name, station_id) VALUES (%s, %s, %s)"
val = [
    (1, 'A', 1),
    (2, 'B', 1),
    (3, 'C', 1),
